...
There's 2 versions of KDE Plasma. If you're on **Plasma 5** then **this is the branch** you need. **Otherwise** (if you use Plasma 6 like me), **switch to the plasma-6 branch**.
