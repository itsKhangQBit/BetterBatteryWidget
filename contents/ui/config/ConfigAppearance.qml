...
import QtQuick.Dialogs 1.3 // for the color dialog
...
ScrollView {
    ...
    property alias cfg_panelfontFamily: panelfontDiag.font.family
    ...
    property alias cfg_popupfontFamily: popupfontDiag.font.family
    ...
    Kirigami.FormLayout {
        ...
        FontDialog {
            id: panelfontDiag
            onFontChanged: {
                plasmoid.configuration.panelfontFamily = font.family
            }
        }
        ...
        RowLayout {
            ...
            PlasmaComponents.Button {
                ...
                onClicked: {
                    panelfontDiag.font.family = plasmoid.configuration.panelfontFamily
                    panelfontDiag.open()
                }
            }
        }
        ...
        FontDialog {
            id: popupfontDiag
            onFontChanged: {
                plasmoid.configuration.popupfontFamily = font.family
            }
        }
        ...
        RowLayout {
            ...
            PlasmaComponents.Button {
                ...
                onClicked: {
                    ...
                    popupfontDiag.font.family = plasmoid.configuration.popupfontFamily
                    popupfontDiag.open()
                }
            }
        }
